...
class TestInline(unittest.TestCase):
    ...
    def test_text_to_textnodes_1(self):
        test_in = "This is **text** with an _italic_ word and a `code block` and an ![obi wan image](https://i.imgur.com/fJRm4Vk.jpeg) and a [link](https://boot.dev)"
        test_out = text_to_textnodes(test_in)
        self.assertListEqual(
            [
